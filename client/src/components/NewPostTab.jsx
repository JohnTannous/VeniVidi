...
const NewPostTab = () => {
  ...
  }, [postImage, postContentOne, postContentTwo, postTitle, postCategory, postAuthor, blogPostCreated]);

  const handlePublishPost = () => {
    if (postImage === '' || postCategory === '' || postContentOne === '' || postContentTwo === '' || postTitle === '' || postAuthor === '') {
      toast({
  ...
  return (
    <Container maxW='5xl' py={{ base: 12, md: 24 }} px={{ base: 0, md: 8 }} minH='4xl'>
      <Stack spacing='5'>
        ...
        <Input placeholder='Author' size='md' onChange={(e) => setPostAuthor(e.target.value)} />
